...
if __name__=="__main__":
    ...
    access_times = 3#2*NN-1#1#len(A)//2 513#
    ...
    pic = open('/home/zxl/local/hORAM/Ours/Result/OursLogOP2_BlockNum{}_Blockize{}.pkl'.format(NN,BlockSize), 'wb') #open(r'.\Ours\Result\BlockNum_{}.pkl'.format(NN), 'wb')
